            ...
            <div class="bg-white dark:bg-zinc-800 p-6 rounded-lg border border-zinc-200 dark:border-zinc-700">
                <div class="flex items-center">
                    <div class="p-2 bg-blue-100 dark:bg-blue-900 rounded-lg">
                        <x-ui.icon name="cube" class="w-6 h-6 text-blue-600 dark:text-blue-400" />
                    </div>
                    <div class="ml-4">
            ...
            <div class="bg-white dark:bg-zinc-800 p-6 rounded-lg border border-zinc-200 dark:border-zinc-700">
                <div class="flex items-center">
                    <div class="p-2 bg-yellow-100 dark:bg-yellow-900 rounded-lg">
                        <x-ui.icon name="exclamation-triangle" class="w-6 h-6 text-yellow-600 dark:text-yellow-400" />
                    </div>
                    <div class="ml-4">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        <div class="flex-shrink-0">
                            <x-ui.icon name="plus-circle" class="w-5 h-5 text-green-500" />
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="flex-shrink-0">
                            <x-ui.icon name="minus-circle" class="w-5 h-5 text-red-500" />
                        </div>
                        <div class="flex-1">
